...
$cdn_audio_enabled = cdn_audio_enabled();
?>
<!DOCTYPE html>
<html lang="es">
<head>
        ...
        <main class="main-content">
            ...
            <div id="dashboard-section" class="section-content">
                <div class="flex justify-between items-center mb-4 flex-wrap gap-2">
                    ...
                    <?php endif; ?>
                    <?php if (!$cdn_audio_enabled): ?>
                    <span class="maintenance-badge bg-yellow-600">
                        <i class="fas fa-triangle-exclamation"></i> CDN DESACTIVADO: USANDO BACKBLAZE
                    </span>
                    <?php endif; ?>
                </div>
                <?php if (!$cdn_audio_enabled): ?>
                <div class="mb-4 rounded-xl border border-yellow-500/40 bg-yellow-500/10 p-4 text-sm text-yellow-100">
                    <div class="font-bold text-yellow-300 mb-1">
                        <i class="fas fa-triangle-exclamation mr-2"></i>Modo respaldo de audio activo
                    </div>
                    <p>Los mixes se estan reproduciendo y descargando directo desde Backblaze. No consumen RAM del hosting, pero la descarga forzada depende del navegador/Backblaze hasta que reactives BunnyCDN.</p>
                </div>
                <?php endif; ?>
