...
// Obtener banners activos para sidebar
$sidebar_banners = [];
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/chat.css?v=20260707-chat-mobile-fixed">
    <style>
        :root {
            --primary: #e1261d;
...
<body class="bg-neutral-950 text-white">
    ...
    <main class="max-w-7xl mx-auto px-4 py-8 pb-20">
        ...
        <div class="main-layout">
            ...
            <div class="content-main">
                ...
                <!-- Super Packs Section (SOLO 3) -->
                <section id="superpacks" class="mb-12">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-bold">🔥 Super Packs</h2>
                        <a href="superpacks.php" class="text-primary hover:text-primary-hover transition text-sm">Ver todos →</a>
                    </div>
                ...
                <section id="top-djs">
                    ...
                    <!-- Botón "Ver todos los DJs" - Sutil -->
                    <div class="text-center mt-8">
                        <a href="lista_djs.php" class="inline-flex items-center gap-2 text-neutral-400 hover:text-primary transition text-sm">
                            <i class="fas fa-users"></i> Ver todos los DJs
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 footer-grid">
                ...
                <div class="footer-links">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="lista_djs.php" class="footer-link text-neutral-400 hover:text-primary text-sm block text-center md:text-left"><i class="fas fa-headphones w-5 text-primary mr-2"></i> Todos los DJs</a></li>
    ...
    <script src="assets/js/chat.js?v=20260707-chat-mobile-fixed"></script>
            ...
            fetch('api/get_stats.php')
                ...
                .then(data => {
                    if (data.super_packs && data.super_packs.length > 0) {
                        // SOLO MOSTRAR LOS PRIMEROS 3 SUPER PACKS
                        const topSuperPacks = data.super_packs.slice(0, 3);
                        
                        container.innerHTML = topSuperPacks.map(pack => `
